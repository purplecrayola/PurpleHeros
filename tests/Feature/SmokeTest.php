...
class SmokeTest extends TestCase
{
    ...
    public function test_non_admin_is_limited_to_self_service_surfaces(): void
    {
        ...
        $this->get('/employee/timesheets')->assertOk();
        $this->get('/employee/overtime')->assertOk();
        $this->get('/employee/holidays')->assertOk()->assertSee('Holidays');
        $this->get('/attendance/employee/page')->assertOk();
        $this->get('/form/leavesemployee/new')->assertOk();
        $this->get('/form/timesheet/page')->assertRedirect(route('employee/timesheets'));
        $this->get('/form/overtime/page')->assertRedirect(route('employee/overtime'));
        ...
        $this->get('/form/salary/page')->assertRedirect('/admin/staff-salaries');
        $this->get('/form/employee/reports/page')->assertRedirect('/admin/reports-hub');
        $this->get('/form/holidays/new')->assertRedirect(route('employee/holidays'));
